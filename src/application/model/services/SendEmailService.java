...
public class SendEmailService extends Service<EmailSendingResult>
{
	...
	public SendEmailService(EmailAccount emailAccount, String subject, String recipient, String content, List<File> attachments)
	{
		super();
		...
		return new Task<EmailSendingResult>() {
			...
			protected EmailSendingResult call()
			{
				try
				{
					...
					mimeMessage.setFrom(emailAccount.getEmailId());
